...
!   control%l_hfc134a        = .FALSE.
  ...
  NAMELIST/socrates_rad_nml/ stellar_constant, tidally_locked, lw_spectral_filename, lw_hires_spectral_filename, &
                             ...
                             o2_mix_ratio, so2_mix_ratio, h2_mix_ratio, ar_mix_ratio, &
                             cfc11_mix_ratio, cfc12_mix_ratio, cfc113_mix_ratio, hcfc22_mix_ratio, &
                             hfc134a_mix_ratio, haze_mix_ratio, &
                             inc_h2o, inc_co2, inc_co, inc_o3, inc_n2o, inc_n2, inc_ch4, inc_o2, &
                             inc_so2, inc_h2, inc_ar, inc_cfc11, inc_cfc12, inc_cfc113, inc_hcfc22, &
