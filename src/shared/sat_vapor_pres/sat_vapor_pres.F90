...
! </PUBLIC>
 ...
 use         constants_mod, only:  TFREEZE, TFREEZE_H2O, RDGAS, RVGAS, HLV, TPPRESS, ES0
...
!  cvs version and tag name
 ...
 character(len=128) :: version = '$Id: sat_vapor_pres.F90,v 19.0.4.1 2013/01/14 19:43:32 pjp Exp $'
 character(len=128) :: tagname = '$Name: siena_201211_pjp $'
...
!----------------------------------------------------------------------- 
  ...
  nlim  = nsize-1
  call sat_vapor_pres_init_k(nsize, real(tcmin), real(tcmax), TFREEZE, TFREEZE_H2O, HLV, &
                             RVGAS, TPPRESS, ES0, err_msg_local, use_exact_qs, do_simple, &
                             construct_table_wrt_liq, &
                             construct_table_wrt_liq_and_ice, &
                             teps, tmin, dtinv)
