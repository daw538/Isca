...
subroutine constants_init
    ...
    if (constants_initialised) then
    
    	write(6,*), 'rdgas:', rdgas
    	write(6,*), 'rvgas:', rvgas
    	write(6,*), 'kappa', kappa
    	write(6,*), 'cp_air:', cp_air
    	write(6,*), 'cp_vapor:', cp_vapor
    	write(6,*), 'dens_liquid:', dens_liquid
    	write(6,*), 'hlv:', hlv
    	write(6,*), 'hlf:', hlf
    	write(6,*), 'hls:', hls
    	write(6,*), 'tfreeze:', tfreeze
    	write(6,*), 'tppress:', tppress
